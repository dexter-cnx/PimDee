...
export function App() {
  ...
  const startAdaptive=()=>{ if(!adaptiveText)return; setCustomText(adaptiveText); setUsingCustom(true); reset(adaptiveText) }
